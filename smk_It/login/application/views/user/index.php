                ...
                <div class="container-fluid">
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-4">
                        <img size="200" class="rounded mx-auto d-block" src="<?= base_url('assets/img/profile/') . $user['image']?>">
                        </div>
                        <div class="col-md-8">
                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>: <span class="card-text mb-3"> <?= $user['id']; ?></span></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Name</th>
                                        <td>: <span class="card-title"><?= $user['name']; ?></span></td>
                                    </tr>
                                    <tr>
